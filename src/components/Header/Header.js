...
import {search_click} from './scroll_header';

class NavBar extends React.Component {

    search_click2 = search_click
    // constructor(props){
    //     super(props);
        ...
        return (
            <div>
                ...
                <div id="navbar">
                    ...
                    <div id="icon"></div>
                    <img src="media\img\header\search.png" alt="" id="search_icon" onClick={this.search_click2.bind(this)}/>
                    <div id="search">
